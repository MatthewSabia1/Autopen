/*
  ...
  1. Security Updates
    - Completely disable RLS on projects and creator_contents tables
    - Remove all existing restrictive policies that are causing failures
    - Create new, properly permissive policies
    - Grant necessary permissions to authenticated role
    - Re-enable RLS with working policies
  
  This migration specifically addresses the "new row violates row-level security policy" errors
  by ensuring authenticated users can properly insert data into the tables.
*/
