    ...
    <div className="w-full max-w-4xl mx-auto bg-paper rounded-lg shadow-sm border border-accent-tertiary/20 p-8 my-8">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-1/3 flex flex-col items-center">
          <div 
            className="relative w-48 h-48 rounded-full bg-cream border-4 border-accent-tertiary/30 overflow-hidden cursor-pointer group"
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 font-serif ${!isEditing ? 'bg-cream/50 cursor-not-allowed' : 'bg-cream'} border border-accent-tertiary/30 rounded-md focus:outline-none focus:ring-1 focus:ring-accent-primary`}
            ...
            <div className="pt-2">
              <button
                type="submit"
                disabled={isSaving}
                className={`px-6 py-3 font-serif rounded flex items-center justify-center transition-colors ${isEditing ? 'bg-accent-primary text-white hover:bg-accent-primary/90' : 'bg-accent-secondary text-white hover:bg-accent-secondary/90'}`}
              >
                {isSaving ? (
                  <>
