...
const SettingsLayout: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-6 py-8">
      <h1 className="font-display text-3xl text-ink-dark mb-8">Settings</h1>

      <div className="flex flex-col md:flex-row gap-6">
        {/* Sidebar */}
        <aside className="md:w-1/4">
          <div className="bg-paper rounded-lg shadow-sm border border-accent-tertiary/20 p-4">
            <nav>
        ...
        <main className="md:w-3/4">
          ...
          {activeTab === 'security' && (
            <div className="bg-paper rounded-lg shadow-sm border border-accent-tertiary/20 p-8">
