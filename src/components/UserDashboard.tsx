...
import { BookOpen, Plus, Clock, PenTool, BookText, Settings, Zap, Award, ArrowRight, ChevronRight, CloudLightning as Lightning, FileText, Layers, Crown, Wand2 } from 'lucide-react';
